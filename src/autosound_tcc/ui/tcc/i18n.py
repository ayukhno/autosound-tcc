...
Choose sweeps (sw) above to read this.",
    ...
    "uk": {
        ...
        "selfAliasSameModel": "{keys} — це та сама модель, лише з префіксом харнеса, який її запускає. Нічого не підмінено: так виправлено ім'я, записане без префікса. Прибрати псевдонім безпечно, якщо старіші записи вже не посилаються на коротке ім'я.",
