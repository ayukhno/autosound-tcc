...
answers the first five questions anybody would ask.",
        ...
        "tfAction": "Fix in REW…",
        "tfTitle": "Fix the titles in REW",
        "tfBlurb": "Each is renamed in REW, REW is read back, and only what REW shows renamed is recorded in the round. A spelling difference comes ticked; a likely typo does not — tick it if that is the name you meant.",
        "tfGrammar": "the round's spelling",
        "tfTypo": "likely a typo — check",
        "tfApply": "Rename",
        "tfDone": "Renamed in REW and recorded in the round: {n}.",
        "tfFailed": "The rename stopped: {said}",
...
питань, які тобі поставлять.",
        ...
        "tfTitle": "Виправити назви в REW",
        "tfBlurb": "Кожен замір перейменовується в REW, REW читається назад, і в раунд записується лише те, що REW показує перейменованим. Різниця в записі позначена одразу; ймовірна одруківка — ні: познач її, якщо мав на увазі саме цю назву.",
        "tfGrammar": "як у раунді",
        "tfTypo": "схоже на одруківку — перевір",
        "tfApply": "Перейменувати",
        "tfDone": "Перейменовано в REW і записано в раунд: {n}.",
        "tfFailed": "Перейменування зупинилось: {said}",
...
Щоб це читати, обери вище заміри свіпом (sw).",
    ...
    "pl": {
        ...
        "tfTitle": "Popraw nazwy w REW",
        "tfBlurb": "Każdy pomiar zmienia nazwę w REW, REW jest odczytywany ponownie i do rundy trafia tylko to, co REW pokazuje jako zmienione. Różnica w zapisie jest zaznaczona od razu; prawdopodobna literówka nie — zaznacz ją, jeśli chodziło o tę nazwę.",
        "tfGrammar": "jak w rundzie",
        "tfTypo": "prawdopodobnie literówka — sprawdź",
        "tfApply": "Zmień nazwy",
        "tfDone": "Zmieniono w REW i zapisano w rundzie: {n}.",
        "tfFailed": "Zmiana nazw zatrzymała się: {said}",
    ...
    "de": {
        ...
        "tfTitle": "Titel in REW korrigieren",
        "tfBlurb": "Jede Messung wird in REW umbenannt, REW wird zurückgelesen, und in die Runde kommt nur, was REW als umbenannt zeigt. Ein Schreibunterschied ist schon angehakt, ein wahrscheinlicher Tippfehler nicht — hake ihn an, wenn du genau diesen Namen meintest.",
        "tfGrammar": "wie in der Runde",
        "tfTypo": "wohl ein Tippfehler — prüfen",
        "tfApply": "Umbenennen",
        "tfDone": "In REW umbenannt und in der Runde festgehalten: {n}.",
        "tfFailed": "Das Umbenennen hat angehalten: {said}",
