...
answers the first five questions anybody would ask.",
        ...
        "riImportTip": "Reads a Resonalyze virtual-DSP session into this project's vocabulary and checks every value against what your processor can actually be given. It refuses rather than rounds, and writes nothing.",
        "menuStartSession": "Start a tuning session in TCC",
        "menuTerminal": "Open a terminal on this project",
        "menuModels": "Configure models…",
...
питань, які тобі поставлять.",
        ...
        "riImportTip": "Читає сесію віртуального DSP Resonalyze у словник цього проєкту і звіряє кожне значення з тим, що ваш процесор справді може прийняти. Відмовляє, а не округлює, і нічого не записує.",
        "menuStartSession": "Почати сесію тюнінгу в TCC",
        "menuTerminal": "Відкрити термінал у цьому проєкті",
        "menuModels": "Налаштувати моделі…",
