...
Start TCC again; if it keeps happening, the reason is here and in the log:",
        ...
        "cliRouteNotAsked": "{routes} is installed; its model list is not asked automatically here, because on Windows the command opens a console window that cannot be hidden. Press ↻ to ask it.",
...
ще раз; якщо повторюється — причина тут і в лозі:",
        ...
        "cliRouteNotAsked": "{routes} встановлено; його список моделей тут не питається сам, бо під Windows ця команда відкриває консольне вікно, яке не сховати. Натисни ↻, щоб запитати.",
...
Щоб це читати, обери вище заміри свіпом (sw).",
    ...
    "pl": {
        ...
        "modelAliased": '{old} działa teraz jako {new} na tej maszynie. Sesje to mówią, żeby zapis nie twierdził '
                        'czegoś innego.',
        "cliRouteNotAsked": '{routes} jest zainstalowany; jego lista modeli nie jest tu pytana automatycznie, bo w Windows to polecenie otwiera okno konsoli, którego nie da się ukryć. Naciśnij ↻, aby zapytać.',
    ...
    "de": {
        ...
        "cliRouteNotAsked": '{routes} ist installiert; seine Modellliste wird hier nicht automatisch abgefragt, weil der Befehl unter Windows ein Konsolenfenster öffnet, das sich nicht verbergen lässt. Drücke ↻, um zu fragen.',
