...
T: dict[Lang, dict[str, str]] = {
    "en": {
        ...
        "curveShift": "shift 2nd",
        "curveShiftTip": "Delay the second curve. On the impulse it slides in time; on the phase it is the same fact as a ramp (φ = −360·f·Δt). Nothing is applied — the reading goes out as a proposal.",
        "curveShiftReading": "{name} shifted {ms} ms to align (proposed, not applied)",
        ...
        "modelLowEffort": "reduced effort",
        "modelLowEffortTip": "The recommended class, at a lower effort — which is why it is not bold. A reviewer asked to think less tends to agree with you, and agreeing is the one thing a reviewer must not do.",
    ...
    "uk": {
        ...
        "curveShift": "зсув 2-ї",
        "curveShiftTip": "Затримати другу криву. На імпульсній вона їде в часі; на фазі це той самий факт у вигляді нахилу (φ = −360·f·Δt). Нічого не застосовується — прочитання йде як пропозиція.",
        "curveShiftReading": "{name} зсунуто на {ms} мс для вирівнювання (пропозиція, не застосовано)",
        ...
        "modelLowEffort": "знижене зусилля",
        "modelLowEffortTip": "Рекомендований клас, але на нижчому зусиллі — тому не жирний. Рецензент, якого попросили думати менше, схильний погоджуватися, а погоджуватись — це єдине, чого рецензент робити не має.",
