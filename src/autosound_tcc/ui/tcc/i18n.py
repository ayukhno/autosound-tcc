...
Start TCC again; if it keeps happening, the reason is here and in the log:",
        ...
        "gateAskBody": "When should the tuning session ask you before running a command? It reads measurements and writes the project's files on this machine. Anything that cannot be undone always asks; you can change this in the menu.",
...
ще раз; якщо повторюється — причина тут і в лозі:",
        ...
        "gateAskBody": "Коли сесія тюнінгу має питати вас перед командою? Вона читає заміри й пише файли проєкту на цій машині. Те, чого не відкотити, питає завжди; вибір можна змінити в меню.",
...
Щоб це читати, обери вище заміри свіпом (sw).",
    ...
    "pl": {
        ...
        "gateAskBody": "Kiedy sesja strojenia ma pytać cię przed wykonaniem polecenia? Czyta pomiary i zapisuje pliki projektu na tej maszynie. To, czego nie da się cofnąć, pyta zawsze; wybór zmienisz w menu.",
    ...
    "de": {
        ...
        "gateAskBody": "Wann soll die Einmess-Sitzung dich fragen, bevor sie einen Befehl ausführt? Sie liest Messungen und schreibt die Projektdateien auf diesem Rechner. Was sich nicht rückgängig machen lässt, fragt immer; ändern kannst du das im Menü.",
