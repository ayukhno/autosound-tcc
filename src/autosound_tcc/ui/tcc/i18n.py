...
answers the first five questions anybody would ask.",
        ...
        "capImportColHp": "HP Hz",
        "capImportColLp": "LP Hz",
        "capImportProtTip": "What was in the signal path while this was swept, so it can be taken back out of the curve. A frequency here means LR24 — for anything else, use Protection. Empty means the curve is read as measured.",
...
питань, які тобі поставлять.",
        ...
        "capImportColHp": "ФВЧ Гц",
        "capImportColLp": "ФНЧ Гц",
        "capImportProtTip": "Що було в тракті, поки це знімалось, — щоб вийняти його з кривої. Частота тут означає LR24; якщо було інше, це в «Захисті». Порожньо — криву читають як зняту.",
...
Щоб це читати, обери вище заміри свіпом (sw).",
    ...
    "pl": {
        ...
        "capImportColHp": 'HP Hz',
        "capImportColLp": 'LP Hz',
        "capImportProtTip": 'Co było w torze, gdy to nagrywano — żeby dało się to wyjąć z krzywej. Częstotliwość tutaj oznacza LR24; cokolwiek innego — w „Ochronie". Pusto: krzywa czytana tak, jak ją nagrano.',
    ...
    "de": {
        ...
        "capImportColHp": 'HP Hz',
        "capImportColLp": 'LP Hz',
        "capImportProtTip": 'Was im Signalweg lag, als das gemessen wurde — damit es wieder aus der Kurve genommen werden kann. Eine Frequenz hier heißt LR24; für alles andere der Schutz-Dialog. Leer: die Kurve wird gelesen, wie sie gemessen wurde.',
