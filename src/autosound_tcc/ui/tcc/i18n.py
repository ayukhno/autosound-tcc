...
T: dict[Lang, dict[str, str]] = {
    "en": {
        ...
        "diagInherited": "Carried in from another project (confirm here or measure again)",
        ...
        "factInherited": "inherited — confirm here or measure",
        "diagMissing": "missing",
...
Choose sweeps (sw) above to read this.",
    ...
    "uk": {
        ...
        "diagInherited": "Перенесено з іншого проекту (підтвердити тут або зміряти знову)",
        ...
        "factInherited": "успадковано — підтвердити тут або зміряти",
        "diagMissing": "немає",
...
Щоб це читати, обери вище заміри свіпом (sw).",
    ...
    "pl": {
        ...
        "diagInherited": 'Przeniesione z innego projektu (potwierdź tutaj albo zmierz ponownie)',
        ...
        "factInherited": 'przeniesione — potwierdź tutaj albo zmierz',
        "diagMissing": 'brak',
    ...
    "de": {
        ...
        "diagInherited": 'Aus einem anderen Projekt übernommen (hier bestätigen oder neu messen)',
        ...
        "factInherited": 'übernommen — hier bestätigen oder messen',
        "diagMissing": 'fehlt',
