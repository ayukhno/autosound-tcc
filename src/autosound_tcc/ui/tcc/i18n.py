...
T: dict[Lang, dict[str, str]] = {
    "en": {
        ...
        "cfgThemeDark": "dark",
        "carLabel": "Car",
        "carNone": "No car recorded — this project answers \"no body\" to every question about the cabin, and no earlier build on it can be matched.",
        "carNoBody": "The body is not recorded — a sedan and a wagon cannot be told apart, so no earlier build on this cabin will be matched.",
        ...
        "curveNotInRew": "REW is not holding this measurement right now — open the file it was captured in.",
        # S-048: a second tune of the same car starts from the first one's measurements, so a
        # foreign `_N` is the ordinary path rather than an edge case.
        ...
        "protNeedsReason": "A correction needs a reason — without one it cannot be told from a second opinion.",
        # The reason that used to be "could not reach GitHub" whatever went wrong. git's own
        # words follow it, because on the Arbiter's Mac git could not run at all and the window
        # sent us both to check the network.
        "updWhy_probe_failed": "the version could not be asked for — git said",
        ...
        "rewPort": "REW port",
        "mcpNoConfig": "TCC is running and reachable, but `.mcp.json` could not be written ({error}). A CLI started in the project folder will not find TCC; the window's own session is unaffected.",
        ...
        "selfPinOkTitle": "Nothing to compare the vendored method against",
        "selfPinAtTitle": "The vendored method is at {tag}, the newest release this checkout knows of",
        "selfPinBehindTitle": "The method has released {tag} — the pin is {n} commit(s) behind it",
        "selfPinBehindDetail": "The pin is deliberate: a live link to the method's main branch would hand this app a line that is unstable on purpose, and a red suite would no longer say whose change broke it. Falling behind is normal between releases — being unable to SEE it is not. Read locally, without asking the network, so a newer tag may exist that this checkout has not fetched. To take it: git -C vendor/autosound-tuning-skill fetch --tags && git -C vendor/autosound-tuning-skill checkout {tag}, then run the suite before committing the new pin.",
        ...
        "diagBtnTip": 'Project check. Updates. Installation and run logs.',
        ...
        "diagInherited": "Carried in from another project",
        "diagInheritedFrom": "from {path}",
        "diagSourceGone": "Source no longer exists: {path} — what came from it stays valid, but cannot be re-checked there",
        "factInherited": "inherited from another project",
        "diagMissing": "missing",
        ...
        "diagReportShot": "the form takes a screenshot — drag it in",
...
answers the first five questions anybody would ask.",
        ...
        "diagSessionsSave": "Save sessions…",
        "diagSessionsNone": "No agent sessions of this project on this machine.",
        "diagSessionsSaved": "{n} session(s) saved: {path}",
        "diagTabSessions": "AI history",
        "diagSessionsPick": "Sessions of {project}:",
        "diagSessionsTickAll": "select all",
        "diagSessionsTickNone": "clear",
        "diagSessionsOneFile": "one file",
        "diagSessionsEachFile": "each session separately (zip)",
        "diagSessionsNameLabel": "Save as:",
        "diagSessionsFolder": "in folder:",
        "diagSessionsBrowse": "Browse…",
        "diagSessionsSaveN": "Save {n} session(s)",
        "diagSessionsRow": "{when} · {size} · {phase}",
        "diagSessionsNoPhase": "—",
        "diagSessionsPhase": "phase {phase}",
        ...
        "acousticsShownOf": "{shown} of {total} shown",
        "flawHypothesis": "not settled",
        "flawStatusUnstated": "status not stated",
        ...
        "flawAction_level": "level the pair",
        ...
        "flawKind_level_tilt": "level tilt",
        ...
        "npSeedSummary": "Source: {car} · {dsp} · {channels} channels",
        ...
        "unusableSummary": "Unusable captures: {n} — {first}",
        "unusableShow": "show all",
        "unusableTitle": "Unusable captures",
        "capImportSelectAll": "Select all",
        "capImportSelectNone": "Clear selection",
        "captureReady": "Done",
        "captureReadyTip": "The captures in front of you are taken — tell the AI to start on them. Sent as a signal, so a session in a terminal gets it too. Active once the open round has taken something.",
        "captureReadySent": "Round {round}: {n} captures handed to the AI.",
        "captureReadyQueued": "Round {round}: {n} captures handed over — no session is running; the next one starts with it.",
        ...
        "protNoRound": "No capture round is open, so there is nothing to record against — a protective record belongs to the pass it was measured in. Take measurements in with ⤓ and the pass opens with them.",
        "protWhy": "A protective filter is IN the recording: it rotates phase far past its own corner, and a junction three times away from it can carry about fifty degrees that belong to the measuring rig rather than to the car. Written down here, it can be taken back out of the curve before the curve is read. Left empty, the curve is read exactly as measured — which is the right answer for a sweep taken through the tune you are building, filters and all.",
        "protHp": "HP Hz",
        "protLp": "LP Hz",
        "protSave": "Record",
        ...
        "protFormClear": "Clear",
        "protFormOk": "OK",
        "protQuickTip": "LR24 — the usual protective filter, in one press. Type the frequency beside it.",
        "capImportTitle": "Take measurements from REW",
        "capImportHead": "This round is waiting for {n}. Tick what came in.",
        "capImportNoTask": "This round expects no captures — anything ticked is taken in as an extra.",
        "capImportColTake": "take",
        "capImportColNum": "no.",
        "capImportColTitle": "in REW",
        "capImportColWhen": "when",
        "capImportOnlyNew": "unprocessed only",
        "capImportMore": "+10 earlier",
        "capImportApply": "Apply",
        "capImportShowing": "Showing what REW is showing now.",
        "splashStarting": "starting…",
        "splashProject": "reading the project…",
        "splashWindow": "building the window…",
        "capRoundOpened": "Capture round {round} opened.",
        "capRoundRecorded": "Recorded in the round: {n}.",
        "capRoundRefused": "The ledger did not take it: {why}",
        "capImportNumTip": "REW's number for it right now — for finding the row in REW, nothing else. A filter or a sort renumbers it, so it is never written down.",
        "capImportPicked": "Ticked by name: {n}.",
        "capImportDupTip": "REW is showing more than one measurement under this name. Which one came out is yours to say — that is why neither is ticked.",
        "capImportDupNote": "The same name twice in REW: {names}. Neither is ticked — pick the one you mean.",
        "capImportRewOrder": "REW's own order — one of the dates could not be read, so capture time is not being used.",
        "capImportMissing": "{n} of this project's imported measurements are not in that list — deleted, or hidden by a filter in REW.",
        "capImportEmpty": "Nothing to show.",
        "capImportAlready": "Already taken into this project.",
        "capImportDone": "Taken in: {n}.",
        "protRefused": "{channel}: {why}",
        "protBtn": "Protection",
        "protBtnTip": 'For raw captures, state the protective filters. Their presence is the signal for the maths '
                      'to clear the measurements of their effect.',
        "protNoChannels": "This project names no channels yet. They come from project.json, which intake writes — until then there is nothing to record a protective filter against.",
        ...
        "interviewConnecting": "Connecting…",
        "interviewThinking": "Thinking…",
        "interviewYourTurn": "Your turn.",
        "interviewYou": "You",
        "interviewSystem": "TCC",
        "interviewSaved": "✅ Profile written: {path}",
        "interviewDone": "The interview is finished — this window can be closed.",
        "interviewEnded": "The interview stopped — nothing more is coming. Close this window and open the session dialog.",
        "interviewError": "Session error.",
        "preset": "Preset",
        "target": "Target curve",
        ...
        "band": "band",
        "legWaitShort": "waiting",
        "legFoundShort": "in REW",
        "legDoneShort": "done",
        "legBadShort": "unusable",
        "legSkipShort": "skipped",
        "legWait": "waiting",
        ...
        "measRead": 'Read the data from REW, matched against the measurements this round expects.',
        "measReading": "Reading from REW…",
        "measReadCancelled": "REW is showing {n} measurement(s). Nothing taken in.",
        "measReadFail": "Could not read from REW: {error}",
        "measReadNoMeas": "No measurements found in REW.",
        "measUsedInStep": "Used in step {steps}",
        "assignNames": 'Name the measurements in REW by the rules, in an order you can set yourself.',
        "capImportColName": "new name",
        ...
        "capImportOffGrammar": "“{name}” is not in the naming grammar: {why}.",
        "capImportHp": "HP",
        "capImportLp": "LP",
        "capImportProtClash": "Two rows describe different chains for the same channel: {channels}. Nothing was written.",
        "capImportProtSaved": "Protection recorded for: {channels}.",
        "capImportProtRefusedLine": "Protection refused — {line}",
        "capImportProtRefused": "{channel}: {why}",
        "protNotInRecord": "Protection for {channels} was written without an error, but the round's record does not hold it: TCC did not write what it thinks it wrote. That is a defect in TCC — please report it (⚙ ▸ Report a problem).",
        "capImportGiveNames": "Give names",
        "capImportRenaming": "Renaming {n} measurement(s) in REW…",
        "capImportRetake": "Captured after the one below it — a re-take. Check which name lands on it.",
        "capImportNoUuid": "REW gives this one no uuid, so it cannot be recognised again after a rename.",
        "capImportUneven": "The names and the measurements do not line up: {rows} measurement(s) left without a name, {names} name(s) left over. A re-take usually does this — untick it, or start one row lower.",
        "capImportClash": "REW would hold one name twice: {names}. Nothing was sent.",
        "capImportGone": "REW is no longer showing the measurement that was to become {title} — deleted, or hidden by a filter. Nothing further was renamed.",
        "capImportRenamed": "Taken in: {n}, renamed: {renamed}.",
        "capImportRenameFail": "Renamed {n} before it stopped: {error} Taken in: {taken}.",
        "captureOrderMoveTip": "Move the selected rows together: to the top, up one, down one, to the bottom.",
        "captureOrderCopyFrom": "Order as in {method}",
        "captureOrderSave": "Save order",
        "captureOrderSaveTip": "Keep this order for this method and preset, so the list opens this way next time.",
        "captureOrderSaved": "Saved for {method}.",
        "captureOrderTitle": "Capture order",
        "captureOrderHint": "Pick the capture method, then drag to match the order you actually capture channels in REW. Select several rows (Shift for a range, Cmd/Ctrl for single ones) to move them together. «Save order» keeps it for this method and preset; next time the list opens that way.",
        "captureMethodSw": "SW",
...
Start TCC again; if it keeps happening, the reason is here and in the log:",
        ...
        "fbHead": "Message the developer",
        "fbHint": "Tell us what you like / what to change. Use the B / I / list buttons — no "
                  "need to type markdown by hand.",
        "fbPh": "What happened, what to change, what is unclear…",
        "fbCancel": "Cancel",
        "fbShotsAdd": "Add screenshots…",
        "fbShotsKind": "Images",
        "fbShotsPick": "Screenshots to send with the report",
        "fbShotsWarn": "These go to a PUBLIC repository and cannot be taken back. Look at each one first — a window shot carries the file path, the car and whatever else was on screen. Click a picture to open it full size; × drops it.",
        "fbShotsOpen": "open full size",
        "fbShotsDrop": "do not send this one",
        "fbShotsAlt": "screenshot {n}",
        "fbShotsUnreadable": "Not sent, could not be opened to show you: {names}",
        "fbShotsFailed": "Stopped: {problem}. Already published and NOT retractable: {n}.",
        "fbSendGithub": "Send to GitHub →",
        "fbSendForm": "Send →",
        "fbVia": "How to send:",
        "fbViaGithub": "GitHub issue (I have an account)",
        "fbViaForm": "Without GitHub — straight to the developer, text only",
        "fbKind": "What is it:",
        "fbKindProblem": "a problem",
        "fbKindWish": "a wish",
        "fbKindFeedback": "feedback",
        "fbGoesWith": "Goes with your words:",
        "fbEmpty": "Write what happened first.",
        "fbSending": "Sending…",
        "fbSent": "Sent — thank you.",
        "fbNotSent": "Not sent: {problem}. Your text is on the clipboard.",
        "fbNoConfirm": "the form did not confirm it was received",
        "fbClose": "Close",
        "fbFrom": "From:",
        "fbFromPh": "your name and a contact: email, Telegram or phone",
        "fbNoSender": "Say who you are and how to answer you — the developer replies to people.",
        "fbImpact": "How far does it stop your tuning?",
        "fbImpactStops": "It stops me: I cannot go on tuning",
        "fbImpactWorkaround": "It gets in the way, but I can work around it",
        "fbImpactNone": "It does not get in the way",
        "fbNoImpact": "Choose how far it stops your tuning.",
        "dialog": "AI dialog",
        ...
        "gateAskNever": "Don't ask",
        "gateAskForeign": "Outside the project",
        "gateAskWrites": "Every write",
        "gateAskTitle": "Agent commands",
        "gateAskBody": "The tuning session runs commands on this machine — reading measurements, writing the project's own files. How much of that should stop and ask you? Asked once; change it any time in the menu. Anything that cannot be undone will ask whatever you pick.",
        ...
        "queueSendNow": "Interrupt and send",
        "queueSendNowTip": "Stops the turn that is running and sends your message now. Leave it, and the message goes out on its own when this turn ends.",
...
it is selected — and it is not in the sum either. It is shown faint for that reason.",
        ...
        "curveZoomOut": "Zoom out sideways — a wider span left to right",
        "curveZoomOutShort": "X−",
        "curveZoomIn": "Zoom in sideways — a narrower span left to right",
        "curveZoomInShort": "X+",
        "curveZoomYOut": "Flatten the curves — a wider range up the scale",
        "curveZoomYOutShort": "Y−",
        "curveZoomYIn": "Stretch the curves taller — a narrower range up the scale",
        "curveZoomYInShort": "Y+",
...
Choose sweeps (sw) above to read this.",
        "curveBtn": 'Curve analysis. Delays and APF filters. What they do to phase, to the impulse and to the '
                    'summed curve.',
        ...
        "sessionDropped": "The connection to the model dropped — that answer is the harness speaking, not the model. This session cannot carry another message; start a fresh one with \u00ab{new}\u00bb above.",
        ...
        "lsnBtn": 'Listening',
        "lsnBtnTip": 'A template for writing up what you heard on the test tracks — the prompts come from what the '
                     'library already analyses.',
    ...
    "uk": {
        ...
        "cfgThemeDark": "темна",
        "carLabel": "Авто",
        "carNone": "Авто не записано — цей проєкт назавжди відповідає «кузов невідомий», і жоден минулий проєкт на ньому не зіставиться.",
        "carNoBody": "Кузов не записано — седан і універсал не розрізнити, тож минулі проєкти на цьому кузові не знайдуться.",
        ...
        "updWhy_probe_failed": "не вдалося спитати про версію — git каже",
        ...
        "rewPort": "Порт REW",
        "mcpNoConfig": "TCC працює й доступний, але `.mcp.json` не записався ({error}). CLI, запущений у теці проєкту, TCC не знайде; на сесію в самому вікні це не впливає.",
        ...
        "selfPinOkTitle": "Немає з чим порівняти запінений метод",
        "selfPinAtTitle": "Запінений метод на {tag} — найновішому релізі, який знає цей чекаут",
        "selfPinBehindTitle": "Метод випустив {tag} — пін відстає на {n} коміт(ів)",
        "selfPinBehindDetail": "Пін навмисний: живий лінк на гілку main методу віддав би застосунок під навмисно нестабільну лінію, і червоний сьют перестав би казати, чия зміна зламала. Відставати між релізами — нормально; НЕ БАЧИТИ цього — ні. Читається локально, без мережі, тож новіший тег може існувати й бути не притягнутим. Щоб узяти: git -C vendor/autosound-tuning-skill fetch --tags && git -C vendor/autosound-tuning-skill checkout {tag}, і прогнати сьют перед комітом нового піна.",
        ...
        "diagBtnTip": 'Перевірка проєкту. Оновлення. Логи інсталяції та роботи.',
        ...
        "diagInherited": "Перенесено з іншого проекту",
        "diagInheritedFrom": "з {path}",
        "diagSourceGone": "Джерела вже нема: {path} — перенесене з нього лишається чинним, але перевірити його там уже не можна",
        "factInherited": "перенесено з іншого проекту",
        "diagMissing": "немає",
        ...
        "diagReportShot": "у формі можна перетягнути знімок екрана",
...
питань, які тобі поставлять.",
        ...
        "diagSessionsSave": "Зберегти сесії…",
        "diagSessionsNone": "На цій машині нема сесій агента для цього проекту.",
        "diagSessionsSaved": "Збережено сесій: {n} — {path}",
        "diagTabSessions": "Історія з ШІ",
        "diagSessionsPick": "Сесії проєкту {project}:",
        "diagSessionsTickAll": "вибрати все",
        "diagSessionsTickNone": "зняти все",
        "diagSessionsOneFile": "одним файлом",
        "diagSessionsEachFile": "кожна окремо (zip)",
        "diagSessionsNameLabel": "Зберегти як:",
        "diagSessionsFolder": "у теці:",
        "diagSessionsBrowse": "Огляд…",
        "diagSessionsSaveN": "Зберегти сесій: {n}",
        "diagSessionsRow": "{when} · {size} · {phase}",
        "diagSessionsNoPhase": "—",
        "diagSessionsPhase": "фаза {phase}",
        ...
        "acousticsShownOf": "показано {shown} з {total}",
        "flawHypothesis": "не підтверджено",
        "flawStatusUnstated": "стан не названо",
        ...
        "flawAction_level": "вирівняти пару",
        ...
        "flawKind_level_tilt": "перекіс рівня",
        ...
        "npSeedSummary": "Джерело: {car} · {dsp} · каналів: {channels}",
        ...
        "unusableSummary": "Непридатних замірів: {n} — {first}",
        "unusableShow": "показати всі",
        "unusableTitle": "Непридатні заміри",
        "capImportSelectAll": "Вибрати все",
        "capImportSelectNone": "Зняти вибір",
        "captureReady": "Готово",
        "captureReadyTip": "Заміри перед вами взято — сказати ШІ братися за них. Іде сигналом, тож його отримає й сесія в терміналі. Активна, щойно відкритий раунд щось узяв.",
        "captureReadySent": "Раунд {round}: {n} замірів передано ШІ.",
        "captureReadyQueued": "Раунд {round}: {n} замірів передано — сесія не запущена; наступна почне з цього.",
        ...
        "protNoRound": "Набір замірів не відкрито, тож писати нема до чого — запис про захист належить тому проходу, у якому міряли. Візьміть заміри кнопкою ⤓: набір відкриється разом із ними.",
        "protWhy": "Захисний фільтр сидить У ЗАПИСІ: він крутить фазу далеко за власним зрізом, і стик утричі далі може нести близько пʼятдесяти градусів, які належать стенду, а не машині. Записаний тут — його виймають із кривої перед тим, як її читати. Лишений порожнім — крива читається як знята, і це правильна відповідь для свіпу, знятого крізь тюн, який ти будуєш, разом із його фільтрами.",
        "protHp": "ФВЧ Гц",
        "protLp": "ФНЧ Гц",
        "protSave": "Записати",
        ...
        "protFormOk": "Гаразд",
        "protQuickTip": "LR24 — звичайний захисний фільтр, одним натисканням. Частоту впиши поруч.",
        "capImportTitle": "Взяти заміри з REW",
        "capImportHead": "Раунд чекає на {n}. Познач, що знялося.",
        "capImportNoTask": "Цей раунд замірів не очікує — позначене береться як додаткове.",
        "capImportColTake": "брати",
        "capImportColNum": "№",
        "capImportColTitle": "у REW",
        "capImportColWhen": "коли",
        "capImportOnlyNew": "тільки необроблені",
        "capImportMore": "+10 попередніх",
        "capImportApply": "Застосувати",
        "capImportShowing": "Показано те, що REW показує зараз.",
        "splashStarting": "запускається…",
        "splashProject": "читаємо проєкт…",
        "splashWindow": "готуємо вікно…",
        "capRoundOpened": "Відкрито набір {round}.",
        "capRoundRecorded": "Записано в набір: {n}.",
        "capRoundRefused": "Журнал не прийняв: {why}",
        "capImportNumTip": "Номер у REW зараз — щоб знайти рядок у REW, і більше нічого. Фільтр чи сортування його змінюють, тому він ніде не зберігається.",
        "capImportPicked": "Позначено за назвою: {n}.",
        "capImportDupTip": "REW показує під цією назвою не одну криву. Котра з них знялася — каже людина, тому не позначено жодної.",
        "capImportDupNote": "Однакова назва в REW двічі: {names}. Не позначено жодної — вибери потрібну.",
        "capImportRewOrder": "Порядок REW — одну з дат не вдалося прочитати, тож час зйомки не використано.",
        "capImportMissing": "{n} імпортованих цим проєктом у цьому списку нема — видалені або сховані фільтром у REW.",
        "capImportEmpty": "Показувати нема чого.",
        "capImportAlready": "Уже взято в цей проєкт.",
        "capImportDone": "Взято: {n}.",
        "protRefused": "{channel}: {why}",
        "protBtn": "Захист",
        "protBtnTip": 'Для сирих замірів визначте захисні фільтри. Наявність цих фільтрів буде знаком для '
                      'математики очищувати виміри від їхнього впливу.',
        "protNoChannels": "У проєкті ще не названо жодного каналу. Канали приходять із project.json, який пише інтейк, — доки його нема, захисний фільтр нема до чого писати.",
        ...
        "interviewPlaceholder": "Напиши відповідь…",
        "interviewConnecting": "Підключення…",
        "interviewThinking": "Думає…",
        "interviewYourTurn": "Твоя черга.",
        "interviewYou": "Ти",
        "interviewSystem": "TCC",
        "interviewSaved": "✅ Профіль записано: {path}",
        "interviewDone": "Інтервʼю завершено — вікно можна закрити.",
        "interviewEnded": "Інтервʼю зупинилось — далі нічого не буде. Вікно можна закрити й відкрити звичайний діалог.",
        "interviewError": "Помилка сесії.",
        "preset": "Пресет",
        ...
        "measRead": 'Прочитати дані з REW згідно з очікуванням замірів.',
        "measReading": "Читаю з REW…",
        "measReadCancelled": "REW показує замірів: {n}. Нічого не взято.",
        "measReadFail": "Не вдалось прочитати з REW: {error}",
        "measReadNoMeas": "У REW немає замірів.",
        "measUsedInStep": "Використано в кроці {steps}",
        "assignNames": 'Дати назву вимірам в REW згідно з правилами і в порядку, який ви можете визначити.',
        "capImportColName": "нове імʼя",
        ...
        "capImportOffGrammar": "«{name}» не за граматикою назв: {why}.",
        "capImportHp": "ФВЧ",
        "capImportLp": "ФНЧ",
        "capImportProtClash": "Два рядки описують різні тракти для одного каналу: {channels}. Нічого не записано.",
        "capImportProtSaved": "Захист записано для: {channels}.",
        "capImportProtRefusedLine": "Захист не записано — {line}",
        "capImportProtRefused": "{channel}: {why}",
        "protNotInRecord": "Захист для {channels} записано без помилки, але в записі набору його нема: TCC не записав того, що вважає записаним. Це вада TCC — повідомте про неї, будь ласка (⚙ ▸ Повідомити про проблему).",
        "capImportGiveNames": "Дати назву",
        "capImportRenaming": "Перейменовую заміри в REW: {n}…",
        "capImportRetake": "Знято пізніше за той, що нижче, — це перезняття. Перевір, яке імʼя на нього лягає.",
        "capImportNoUuid": "REW не дає цьому заміру uuid, тож після перейменування його не впізнати.",
        "capImportUneven": "Імена й заміри не сходяться: без імені лишилось замірів — {rows}, зайвих імен — {names}. Зазвичай так робить перезняття: зніми з нього галочку або почни на рядок нижче.",
        "capImportClash": "REW тримав би одну назву двічі: {names}. Нічого не надіслано.",
        "capImportGone": "REW більше не показує замір, який мав стати {title}, — видалено або сховано фільтром. Далі нічого не перейменовано.",
        "capImportRenamed": "Взято: {n}, перейменовано: {renamed}.",
        "capImportRenameFail": "Перейменовано {n}, далі зупинилось: {error} Взято: {taken}.",
        "captureOrderMoveTip": "Рухати виділені рядки разом: на початок, на один угору, на один униз, у кінець.",
        "captureOrderCopyFrom": "Порядок як у {method}",
        "captureOrderSave": "Зберегти порядок",
        "captureOrderSaveTip": "Запамʼятати цей порядок для цього методу й пресету, щоб список наступного разу відкрився так.",
        "captureOrderSaved": "Збережено для {method}.",
        "captureOrderTitle": "Порядок зняття",
        "captureOrderHint": "Обери метод зняття, тоді перетягни, щоб порядок відповідав тому, як ти насправді знімаєш канали в REW. Можна виділити кілька рядків (Shift — діапазон, Cmd/Ctrl — окремі) і рухати їх разом. «Зберегти порядок» запамʼятовує його для цього методу й пресету — наступного разу список відкриється так.",
        "captureMethodSw": "SW",
        "captureMethodRta": "RTA",
        "captureMethodRtaGroup": "RTA GROUP",
...
ще раз; якщо повторюється — причина тут і в лозі:",
        ...
        "fbHead": "Написати розробнику",
        "fbHint": "Напишіть, що подобається / що змінити. Скористайтесь кнопками B / I / "
                  "список — набирати markdown руками не треба.",
        "fbPh": "Що сталося, що змінити, що незрозуміло…",
        "fbCancel": "Скасувати",
        "fbShotsAdd": "Додати знімки…",
        "fbShotsKind": "Зображення",
        "fbShotsPick": "Знімки, які поїдуть зі звітом",
        "fbShotsWarn": "Це поїде в ПУБЛІЧНЕ репо, і забрати назад не можна. Спершу подивіться кожен: знімок вікна несе шлях до файлів, машину й усе, що було на екрані. Клік по картинці відкриває її на повний розмір; × прибирає.",
        "fbShotsOpen": "відкрити на повний розмір",
        "fbShotsDrop": "цей не надсилати",
        "fbShotsAlt": "знімок {n}",
        "fbShotsUnreadable": "Не поїде — не вдалося відкрити, щоб показати вам: {names}",
        "fbShotsFailed": "Зупинено: {problem}. Уже опубліковано й НЕ відкликається: {n}.",
        "fbSendGithub": "Надіслати в GitHub →",
        "fbSendForm": "Надіслати →",
        "fbVia": "Як надіслати:",
        "fbViaGithub": "GitHub issue (маю акаунт)",
        "fbViaForm": "Без GitHub — одразу розробнику, лише текст",
        "fbKind": "Що це:",
        "fbKindProblem": "проблема",
        "fbKindWish": "побажання",
        "fbKindFeedback": "відгук",
        "fbGoesWith": "Разом із текстом піде:",
        "fbEmpty": "Спершу напишіть, що сталося.",
        "fbSending": "Надсилаю…",
        "fbSent": "Надіслано — дякую.",
        "fbNotSent": "Не надіслано: {problem}. Текст у буфері обміну.",
        "fbNoConfirm": "форма не підтвердила прийом",
        "fbClose": "Закрити",
        "fbFrom": "Від кого:",
        "fbFromPh": "ім'я і контакт: email, Telegram чи телефон",
        "fbNoSender": "Напишіть, хто ви і як вам відповісти — розробник відповідає людям.",
        "fbImpact": "Наскільки це заважає налаштуванню?",
        "fbImpactStops": "Зупиняє: далі налаштовувати не можу",
        "fbImpactWorkaround": "Заважає, але можна обійти",
        "fbImpactNone": "Не заважає",
        "fbNoImpact": "Виберіть, наскільки це заважає налаштуванню.",
        "dialog": "Діалог з ШІ",
        "dialogSub": "Generator ↔ Critic ↔ Arbiter",
        "planTitle": "План — Факт",
        "planSub": "фази + кроки",
        ...
        "gateAskNever": "Не питати",
        "gateAskForeign": "Поза проєктом",
        "gateAskWrites": "Кожен запис",
        "gateAskTitle": "Команди агента",
        "gateAskBody": "Сесія тюнінгу виконує команди на цій машині — читає заміри, пише файли проєкту. Скільки з цього має спинятись і питати вас? Питаємо один раз; змінити можна будь-коли в меню. Те, чого не відкотити, питатиме за будь-якого вибору.",
        ...
        "queueSendNow": "Перервати й надіслати",
        "queueSendNowTip": "Зупиняє поточний хід і надсилає твоє повідомлення зараз. Якщо не натискати, воно піде саме, щойно хід завершиться.",
...
обраний — і в сумі його теж нема. Тому він блідий.",
        ...
        "curveZoomDetailShort": "D",
        "curveZoomOut": "Віддалити по горизонталі — ширший діапазон",
        "curveZoomOutShort": "X−",
        "curveZoomIn": "Наблизити по горизонталі — вужчий діапазон",
        "curveZoomInShort": "X+",
        "curveZoomYOut": "Стиснути по вертикалі — криві нижчі, шкала ширша",
        "curveZoomYOutShort": "Y−",
        "curveZoomYIn": "Розтягнути по вертикалі — криві вищі, шкала вужча",
        "curveZoomYInShort": "Y+",
...
Щоб це читати, обери вище заміри свіпом (sw).",
        "curveBtn": 'Аналітика кривих. Затримки та APF фільтри. Вплив на фазу, імпульс та Суму кривих.',
        ...
        "sessionDropped": "Зʼєднання з моделлю урвалось — та відповідь від оболонки, не від моделі. Ця сесія більше не донесе повідомлення; почни нову через «{new}» вгорі.",
        ...
        "lsnBtn": 'Слухання',
        "lsnBtnTip": 'Шаблон для формування відгуку про прослуховування тестових треків (підказки з того, що вже '
                     'аналізується на рівні бібліотеки).',
    ...
    "pl": {
        ...
        "cfgThemeDark": 'ciemny',
        "carLabel": 'Auto',
        "carNone": 'Nie zapisano auta — ten projekt na zawsze odpowiada „nadwozie nieznane\", i żaden wcześniejszy projekt na nim się nie dopasuje.',
        "carNoBody": 'Nie zapisano nadwozia — sedana i kombi nie da się rozróżnić, więc wcześniejsze projekty na tym nadwoziu się nie znajdą.',
        ...
        "updWhy_probe_failed": 'nie udało się zapytać o wersję — git mówi',
        ...
        "rewPort": 'Port REW',
        "mcpNoConfig": 'TCC działa i jest osiągalny, ale nie udało się zapisać `.mcp.json` ({error}). CLI uruchomiony w folderze projektu nie znajdzie TCC; sesja w samym oknie działa bez zmian.',
        "rewOnlineTip": 'REW: online',
        ...
        "selfPinOkTitle": 'Nie ma z czym porównać dołączonej metody',
        "selfPinAtTitle": 'Dołączona metoda jest na {tag} — najnowszym wydaniu, jakie zna ta kopia repozytorium',
        "selfPinBehindTitle": 'Metoda wydała {tag} — przypięcie jest {n} commit(ów) za nim',
        "selfPinBehindDetail": 'Przypięcie jest celowe: żywy link do gałęzi main metody oddałby aplikację linii celowo niestabilnej, a czerwony zestaw testów przestałby mówić, czyja zmiana go zepsuła. Zostawanie w tyle między wydaniami jest normalne — brak możliwości ZOBACZENIA tego już nie. Odczyt lokalny, bez sieci, więc nowszy tag może istnieć i nie być pobrany. Aby go wziąć: git -C vendor/autosound-tuning-skill fetch --tags && git -C vendor/autosound-tuning-skill checkout {tag}, a przed zatwierdzeniem nowego przypięcia uruchom testy.',
        ...
        "diagBtnTip": 'Sprawdzenie projektu. Aktualizacje. Logi instalacji i pracy.',
        ...
        "diagInherited": 'Przeniesione z innego projektu',
        "diagInheritedFrom": 'z {path}',
        "diagSourceGone": 'Źródło już nie istnieje: {path} — to, co z niego przeniesiono, pozostaje ważne, ale nie da się tego tam ponownie sprawdzić',
        "factInherited": 'przeniesione z innego projektu',
        "diagMissing": 'brak',
        ...
        "diagReportShot": 'do formularza można przeciągnąć zrzut ekranu',
        ...
        "diagSessionsSave": 'Zapisz sesje…',
        "diagSessionsNone": 'Na tej maszynie nie ma sesji agenta dla tego projektu.',
        "diagSessionsSaved": 'Zapisano sesji: {n} — {path}',
        "diagTabSessions": 'Historia z AI',
        "diagSessionsPick": 'Sesje projektu {project}:',
        "diagSessionsTickAll": 'zaznacz wszystkie',
        "diagSessionsTickNone": 'odznacz',
        "diagSessionsOneFile": 'jeden plik',
        "diagSessionsEachFile": 'każda sesja osobno (zip)',
        "diagSessionsNameLabel": 'Zapisz jako:',
        "diagSessionsFolder": 'w folderze:',
        "diagSessionsBrowse": 'Przeglądaj…',
        "diagSessionsSaveN": 'Zapisz sesje: {n}',
        "diagSessionsRow": '{when} · {size} · {phase}',
        "diagSessionsNoPhase": '—',
        "diagSessionsPhase": 'faza {phase}',
        ...
        "acousticsShownOf": 'pokazano {shown} z {total}',
        "flawHypothesis": 'niepotwierdzone',
        "flawStatusUnstated": 'stan nie podany',
        ...
        "flawAction_crossover": 'crossover',
        "flawAction_level": 'wyrównać parę',
        ...
        "flawKind_level_tilt": 'przechył poziomu',
        ...
        "npSeedSummary": 'Źródło: {car} · {dsp} · kanałów: {channels}',
        ...
        "unusableSummary": "Pomiarów nieużytecznych: {n} — {first}",
        "unusableShow": "pokaż wszystkie",
        "unusableTitle": "Pomiary nieużyteczne",
        "capImportSelectAll": "Zaznacz wszystko",
        "capImportSelectNone": "Odznacz wszystko",
        "captureReady": "Gotowe",
        "captureReadyTip": "Pomiary przed tobą są zdjęte — powiedz AI, żeby się nimi zajęło. Idzie jako sygnał, więc dostanie go też sesja w terminalu. Aktywne, gdy otwarta runda coś przyjęła.",
        "captureReadySent": "Runda {round}: {n} pomiarów przekazano AI.",
        "captureReadyQueued": "Runda {round}: {n} pomiarów przekazano — sesja nie działa; następna od tego zacznie.",
        ...
        "protNoRound": 'Nie otwarto przebiegu pomiarów, więc nie ma do czego pisać — zapis o ochronie należy do tego '
                       'przejścia, w którym mierzono. Weź pomiary przyciskiem ⤓: przebieg otworzy się razem z nimi.',
        "protWhy": 'Filtr ochronny siedzi W NAGRANIU: kręci fazą daleko poza własnym zboczem, a styk trzy razy dalej może nieść około pięćdziesięciu stopni należących do stanowiska, nie do auta. Zapisany tutaj — daje się wyjąć z krzywej, zanim ją odczytamy. Zostawiony pusty — krzywa jest czytana tak, jak ją nagrano, i to jest właściwa odpowiedź dla pomiaru zrobionego przez budowany tune wraz z jego filtrami.',
        "protHp": 'HP Hz',
        "protLp": 'LP Hz',
        "protSave": 'Zapisz',
        ...
        "protFormOk": 'OK',
        "protQuickTip": 'LR24 — zwykły filtr ochronny, jednym naciśnięciem. Częstotliwość wpisz obok.',
        "capImportTitle": 'Pobierz pomiary z REW',
        "capImportHead": 'Ta seria czeka na {n}. Zaznacz to, co się nagrało.',
        "capImportNoTask": 'Ta seria nie oczekuje pomiarów — zaznaczone wchodzi jako dodatkowe.',
        "capImportColTake": 'bierz',
        "capImportColNum": 'nr',
        "capImportColTitle": 'w REW',
        "capImportColWhen": 'kiedy',
        "capImportOnlyNew": 'tylko nieprzetworzone',
        "capImportMore": '+10 wcześniejszych',
        "capImportApply": 'Zastosuj',
        "capImportShowing": 'Pokazano to, co REW pokazuje teraz.',
        "splashStarting": 'uruchamianie…',
        "splashProject": 'czytamy projekt…',
        "splashWindow": 'przygotowujemy okno…',
        "capRoundOpened": 'Otwarto serię {round}.',
        "capRoundRecorded": 'Zapisano w serii: {n}.',
        "capRoundRefused": 'Dziennik nie przyjął: {why}',
        "capImportNumTip": 'Numer w REW teraz — żeby znaleźć wiersz w REW, i nic więcej. Filtr albo sortowanie go zmieniają, więc nigdzie nie jest zapisywany.',
        "capImportPicked": 'Zaznaczono po nazwie: {n}.',
        "capImportDupTip": 'REW pokazuje pod tą nazwą więcej niż jeden pomiar. Który się nagrał — mówi człowiek, dlatego nie zaznaczono żadnego.',
        "capImportDupNote": 'Ta sama nazwa w REW dwa razy: {names}. Nie zaznaczono żadnej — wybierz tę właściwą.',
        "capImportRewOrder": 'Kolejność REW — jednej z dat nie dało się odczytać, więc czas nagrania nie jest używany.',
        "capImportMissing": '{n} pomiarów zaimportowanych przez ten projekt nie ma na tej liście — usunięte albo ukryte filtrem w REW.',
        "capImportEmpty": 'Nie ma czego pokazać.',
        "capImportAlready": 'Już wzięte do tego projektu.',
        "capImportDone": 'Wzięto: {n}.',
        "protRefused": '{channel}: {why}',
        "protBtn": 'Ochrona',
        "protBtnTip": 'Przy surowych pomiarach określ filtry ochronne. Ich obecność jest dla matematyki znakiem, '
                      'żeby oczyścić pomiary z ich wpływu.',
        "protNoChannels": 'Ten projekt nie nazwał jeszcze żadnego kanału. Kanały pochodzą z project.json, który pisze intake — dopóki go nie ma, nie ma do czego pisać filtra ochronnego.',
        ...
        "interviewPlaceholder": 'Wpisz odpowiedź…',
        "interviewConnecting": 'Łączenie…',
        "interviewThinking": 'Myśli…',
        "interviewYourTurn": 'Twoja kolej.',
        "interviewYou": 'Ty',
        "interviewSystem": 'TCC',
        "interviewSaved": '✅ Profil zapisany: {path}',
        "interviewDone": 'Wywiad zakończony — to okno można zamknąć.',
        "interviewEnded": 'Wywiad się zatrzymał — nic więcej nie przyjdzie. Zamknij to okno i otwórz zwykły dialog.',
        "interviewError": 'Błąd sesji.',
        "preset": 'Preset',
        ...
        "measRead": 'Wczytaj dane z REW zgodnie z oczekiwanymi pomiarami.',
        "measReading": 'Czytam z REW…',
        "measReadCancelled": 'REW pokazuje pomiarów: {n}. Nic nie pobrano.',
        "measReadFail": 'Nie udało się odczytać z REW: {error}',
        "measReadNoMeas": 'W REW nie ma pomiarów.',
        "measUsedInStep": 'Użyto w kroku {steps}',
        "assignNames": 'Nazwij pomiary w REW zgodnie z regułami, w kolejności, którą sam ustalasz.',
        "capImportColName": 'nowa nazwa',
        ...
        "capImportOffGrammar": '„{name}” nie pasuje do gramatyki nazw: {why}.',
        "capImportHp": 'HP',
        "capImportLp": 'LP',
        "capImportProtClash": 'Dwa wiersze opisują różne tory dla tego samego kanału: {channels}. Nic nie zapisano.',
        "capImportProtSaved": 'Ochronę zapisano dla: {channels}.',
        "capImportProtRefusedLine": 'Ochrony nie zapisano — {line}',
        "capImportProtRefused": '{channel}: {why}',
        "protNotInRecord": 'Ochronę dla {channels} zapisano bez błędu, ale zapis przebiegu jej nie zawiera: TCC nie zapisał tego, co uważa za zapisane. To błąd TCC — zgłoś go, proszę (⚙ ▸ Zgłoś problem).',
        "capImportGiveNames": 'Nadaj nazwy',
        "capImportRenaming": 'Zmieniam nazwy pomiarów w REW: {n}…',
        "capImportRetake": 'Nagrany później niż ten poniżej — to powtórka. Sprawdź, która nazwa na niego trafia.',
        "capImportNoUuid": 'REW nie daje temu pomiarowi uuid, więc po zmianie nazwy nie da się go rozpoznać.',
        "capImportUneven": 'Nazwy i pomiary się nie zgadzają: bez nazwy zostało pomiarów — {rows}, nazw w nadmiarze — {names}. Zwykle robi to powtórka: odznacz ją albo zacznij wiersz niżej.',
        "capImportClash": 'REW miałby jedną nazwę dwa razy: {names}. Nic nie wysłano.',
        "capImportGone": 'REW nie pokazuje już pomiaru, który miał stać się {title} — usunięty albo ukryty filtrem. Dalej nic nie zmieniono.',
        "capImportRenamed": 'Pobrano: {n}, zmieniono nazw: {renamed}.',
        "capImportRenameFail": 'Zmieniono {n} nazw i zatrzymało się: {error} Pobrano: {taken}.',
        "captureOrderMoveTip": "Przesuń zaznaczone wiersze razem: na początek, o jeden w górę, o jeden w dół, na koniec.",
        "captureOrderCopyFrom": "Kolejność jak w {method}",
        "captureOrderSave": "Zapisz kolejność",
        "captureOrderSaveTip": "Zapamiętaj tę kolejność dla tej metody i presetu, żeby lista następnym razem otworzyła się tak.",
        "captureOrderSaved": "Zapisano dla {method}.",
        "captureOrderTitle": 'Kolejność zdejmowania',
        "captureOrderHint": "Wybierz metodę zdejmowania, potem przeciągnij, żeby kolejność odpowiadała temu, jak naprawdę zdejmujesz kanały w REW. Możesz zaznaczyć kilka wierszy (Shift — zakres, Cmd/Ctrl — pojedyncze) i przesuwać je razem. „Zapisz kolejność” zapamiętuje ją dla tej metody i presetu — następnym razem lista otworzy się tak.",
        "captureMethodSw": 'SW',
        "captureMethodRta": 'RTA',
        "captureMethodRtaGroup": 'RTA GROUP',
        ...
        "copySelection": 'Kopiuj zaznaczone',
        "copyMessage": 'Kopiuj wszystko',
        "aiMain": 'AI main',
        "aiEffort": 'Wysiłek',
        "aiCritic": 'AI critic',
        "effort_high": 'high',
        ...
        "fbHead": 'Napisz do autora',
        "fbHint": 'Napisz, co się podoba / co zmienić. Skorzystaj z przycisków B / I / lista — nie trzeba pisać '
                  'markdowna ręcznie.',
        "fbPh": 'Co się stało, co zmienić, co jest niejasne…',
        "fbCancel": 'Anuluj',
        "fbShotsAdd": 'Dodaj zrzuty…',
        "fbShotsKind": 'Obrazy',
        "fbShotsPick": 'Zrzuty, które pojadą ze zgłoszeniem',
        "fbShotsWarn": 'To trafi do PUBLICZNEGO repozytorium i nie da się tego cofnąć. Najpierw obejrzyj każdy: zrzut okna niesie ścieżkę do plików, auto i wszystko, co było na ekranie. Kliknięcie otwiera pełny rozmiar; × usuwa.',
        "fbShotsOpen": 'otwórz w pełnym rozmiarze',
        "fbShotsDrop": 'tego nie wysyłaj',
        "fbShotsAlt": 'zrzut {n}',
        "fbShotsUnreadable": 'Nie pojedzie — nie udało się otworzyć, by pokazać: {names}',
        "fbShotsFailed": 'Zatrzymano: {problem}. Już opublikowane i NIE do cofnięcia: {n}.',
        "fbSendGithub": 'Wyślij na GitHub →',
        "fbSendForm": 'Wyślij →',
        "fbVia": 'Jak wysłać:',
        "fbViaGithub": 'Issue na GitHubie (mam konto)',
        "fbViaForm": 'Bez GitHuba — prosto do autora, tylko tekst',
        "fbKind": 'Co to jest:',
        "fbKindProblem": 'problem',
        "fbKindWish": 'życzenie',
        "fbKindFeedback": 'opinia',
        "fbGoesWith": 'Razem z tekstem pójdzie:',
        "fbEmpty": 'Najpierw napisz, co się stało.',
        "fbSending": 'Wysyłam…',
        "fbSent": 'Wysłano — dziękuję.',
        "fbNotSent": 'Nie wysłano: {problem}. Tekst jest w schowku.',
        "fbNoConfirm": 'formularz nie potwierdził odbioru',
        "fbClose": 'Zamknij',
        "fbFrom": 'Od kogo:',
        "fbFromPh": 'imię i kontakt: e-mail, Telegram lub telefon',
        "fbNoSender": 'Napisz, kim jesteś i jak ci odpowiedzieć — autor odpowiada ludziom.',
        "fbImpact": 'Na ile to przeszkadza w strojeniu?',
        "fbImpactStops": 'Zatrzymuje: nie mogę dalej stroić',
        "fbImpactWorkaround": 'Przeszkadza, ale da się obejść',
        "fbImpactNone": 'Nie przeszkadza',
        "fbNoImpact": 'Wybierz, na ile to przeszkadza w strojeniu.',
        "dialog": 'Dialog z AI',
        "dialogSub": 'Generator ↔ Critic ↔ Arbiter',
        "planTitle": 'Plan — Fakt',
        "planSub": 'fazy + kroki',
        ...
        "gateAskNever": 'Nie pytaj',
        "gateAskForeign": 'Poza projektem',
        "gateAskWrites": 'Każdy zapis',
        "gateAskTitle": 'Polecenia agenta',
        "gateAskBody": 'Sesja strojenia uruchamia polecenia na tej maszynie — czyta pomiary, zapisuje pliki projektu. Ile z tego ma się zatrzymać i zapytać? Pytamy raz; zmienisz to w menu. To, czego nie da się cofnąć, zapyta przy każdym wyborze.',
        ...
        "queueSendNow": 'Przerwij i wyślij',
        "queueSendNowTip": 'Zatrzymuje trwającą turę i wysyła wiadomość teraz. Bez tego pójdzie sama, gdy ta tura się skończy.',
        ...
        "curveZoomDetailShort": 'D',
        "curveZoomOut": 'Oddal w poziomie — szerszy zakres',
        "curveZoomOutShort": 'X−',
        "curveZoomIn": 'Przybliż w poziomie — węższy zakres',
        "curveZoomInShort": 'X+',
        "curveZoomYOut": 'Spłaszcz w pionie — niższe krzywe, szersza skala',
        "curveZoomYOutShort": 'Y−',
        "curveZoomYIn": 'Rozciągnij w pionie — wyższe krzywe, węższa skala',
        "curveZoomYInShort": 'Y+',
        ...
        "curveKindRtaTip": 'Nie dla pomiaru MMM — REW nie ma dla niego ani impulsowej, ani fazy. Żeby to czytać, wybierz '
                           'wyżej sweepy (sw).',
        "curveBtn": 'Analiza krzywych. Opóźnienia i filtry APF. Ich wpływ na fazę, impuls i sumę krzywych.',
        ...
        "sessionDropped": 'Połączenie z modelem zerwane — ta odpowiedź pochodzi od powłoki, nie od modelu. Ta sesja nie przeniesie kolejnej wiadomości; zacznij nową przez «{new}» u góry.',
        ...
        "lsnBtn": 'Odsłuch',
        "lsnBtnTip": 'Szablon do opisania, co usłyszałeś na utworach testowych — podpowiedzi pochodzą z tego, co '
                     'biblioteka już analizuje.',
    ...
    "de": {
        ...
        "cfgThemeDark": 'dunkel',
        "carLabel": 'Auto',
        "carNone": 'Kein Auto erfasst — dieses Projekt antwortet für immer „Karosserie unbekannt\", und kein früherer Aufbau darauf lässt sich zuordnen.',
        "carNoBody": 'Die Karosserie ist nicht erfasst — Limousine und Kombi sind nicht zu unterscheiden, also werden frühere Aufbauten auf dieser Karosserie nicht gefunden.',
        ...
        "updWhy_probe_failed": 'die Version konnte nicht erfragt werden — git sagt',
        ...
        "rewPort": 'REW-Port',
        "mcpNoConfig": 'TCC läuft und ist erreichbar, aber `.mcp.json` konnte nicht geschrieben werden ({error}). Ein im Projektordner gestartetes CLI findet TCC nicht; die Sitzung im Fenster selbst bleibt unberührt.',
        "rewOnlineTip": 'REW: online',
        ...
        "selfPinOkTitle": 'Es gibt nichts, womit sich die eingebundene Methode vergleichen ließe',
        "selfPinAtTitle": 'Die eingebundene Methode steht auf {tag}, der neuesten Version, die dieser Checkout kennt',
        "selfPinBehindTitle": 'Die Methode hat {tag} veröffentlicht — die Bindung liegt {n} Commit(s) dahinter',
        "selfPinBehindDetail": 'Die Bindung ist Absicht: ein Live-Link auf den main-Branch der Methode würde diese App einer bewusst instabilen Linie ausliefern, und eine rote Testsuite würde nicht mehr sagen, wessen Änderung sie zerbrochen hat. Zwischen Releases zurückzuliegen ist normal — es NICHT SEHEN zu können nicht. Lokal gelesen, ohne Netz, also kann ein neuerer Tag existieren, den dieser Checkout nicht geholt hat. Zum Übernehmen: git -C vendor/autosound-tuning-skill fetch --tags && git -C vendor/autosound-tuning-skill checkout {tag}, danach die Testsuite laufen lassen, bevor die neue Bindung committet wird.',
        ...
        "diagBtnTip": 'Projektprüfung. Updates. Installations- und Laufprotokolle.',
        "diagChecking": 'Prüfe…',
        ...
        "diagInherited": 'Aus einem anderen Projekt übernommen',
        "diagInheritedFrom": 'aus {path}',
        "diagSourceGone": 'Quelle existiert nicht mehr: {path} — was daraus übernommen wurde, bleibt gültig, lässt sich dort aber nicht mehr prüfen',
        "factInherited": 'aus einem anderen Projekt übernommen',
        "diagMissing": 'fehlt',
        ...
        "diagReportShot": 'ins Formular lässt sich ein Screenshot ziehen',
        ...
        "diagSessionsSave": 'Sitzungen speichern…',
        "diagSessionsNone": 'Auf diesem Rechner gibt es keine Agent-Sitzungen dieses Projekts.',
        "diagSessionsSaved": '{n} Sitzung(en) gespeichert: {path}',
        "diagTabSessions": 'KI-Verlauf',
        "diagSessionsPick": 'Sitzungen des Projekts {project}:',
        "diagSessionsTickAll": 'alle auswählen',
        "diagSessionsTickNone": 'Auswahl aufheben',
        "diagSessionsOneFile": 'eine Datei',
        "diagSessionsEachFile": 'jede Sitzung einzeln (ZIP)',
        "diagSessionsNameLabel": 'Speichern als:',
        "diagSessionsFolder": 'im Ordner:',
        "diagSessionsBrowse": 'Durchsuchen…',
        "diagSessionsSaveN": '{n} Sitzung(en) speichern',
        "diagSessionsRow": '{when} · {size} · {phase}',
        "diagSessionsNoPhase": '—',
        "diagSessionsPhase": 'Phase {phase}',
        ...
        "acousticsShownOf": '{shown} von {total} angezeigt',
        "flawHypothesis": 'nicht bestätigt',
        "flawStatusUnstated": 'Status nicht angegeben',
        ...
        "flawAction_level": 'Paar angleichen',
        "flawKind_room_gain": 'Room Gain',
        ...
        "flawKind_level_tilt": 'Pegelschieflage',
        ...
        "npSeedSummary": 'Quelle: {car} · {dsp} · {channels} Kanäle',
        ...
        "unusableSummary": "Unbrauchbare Messungen: {n} — {first}",
        "unusableShow": "alle anzeigen",
        "unusableTitle": "Unbrauchbare Messungen",
        "capImportSelectAll": "Alle auswählen",
        "capImportSelectNone": "Auswahl aufheben",
        "captureReady": "Fertig",
        "captureReadyTip": "Die Messungen vor dir sind aufgenommen — sag der KI, dass sie damit anfangen soll. Geht als Signal, also bekommt es auch eine Sitzung im Terminal. Aktiv, sobald die offene Runde etwas aufgenommen hat.",
        "captureReadySent": "Runde {round}: {n} Messungen an die KI übergeben.",
        "captureReadyQueued": "Runde {round}: {n} Messungen übergeben — keine Sitzung läuft; die nächste beginnt damit.",
        ...
        "protNoRound": 'Es ist keine Messrunde offen, also gibt es nichts, wozu man etwas festhalten könnte — ein '
                       'Schutz-Eintrag gehört zu dem Durchgang, in dem gemessen wurde. Nimm mit ⤓ Messungen herein, '
                       'dann öffnet sich der Durchgang mit ihnen.',
        "protWhy": 'Ein Schutzfilter steckt IN der Aufnahme: er dreht die Phase weit über seine eigene Flanke hinaus, und ein Übergang dreimal weiter oben kann rund fünfzig Grad tragen, die zum Messaufbau gehören und nicht zum Auto. Hier eingetragen, lässt er sich vor dem Lesen wieder aus der Kurve nehmen. Leer gelassen, wird die Kurve so gelesen, wie sie gemessen wurde — die richtige Antwort für einen Sweep durch den Tune, den du gerade baust, samt seiner Filter.',
        "protHp": 'HP Hz',
        "protLp": 'LP Hz',
        "protSave": 'Eintragen',
        ...
        "protFormOk": 'OK',
        "protQuickTip": 'LR24 — der übliche Schutzfilter, mit einem Druck. Die Frequenz daneben eintragen.',
        "capImportTitle": 'Messungen aus REW holen',
        "capImportHead": 'Diese Runde wartet auf {n}. Hake ab, was aufgenommen wurde.',
        "capImportNoTask": 'Diese Runde erwartet keine Aufnahmen — Abgehaktes kommt als Zusatz herein.',
        "capImportColTake": 'nehmen',
        "capImportColNum": 'Nr.',
        "capImportColTitle": 'in REW',
        "capImportColWhen": 'wann',
        "capImportOnlyNew": 'nur unbearbeitete',
        "capImportMore": '+10 frühere',
        "capImportApply": 'Übernehmen',
        "capImportShowing": 'Gezeigt wird, was REW gerade zeigt.',
        "splashStarting": 'startet…',
        "splashProject": 'Projekt wird gelesen…',
        "splashWindow": 'Fenster wird gebaut…',
        "capRoundOpened": 'Aufnahmerunde {round} geöffnet.',
        "capRoundRecorded": 'In der Runde festgehalten: {n}.',
        "capRoundRefused": 'Das Journal hat es nicht angenommen: {why}',
        "capImportNumTip": 'REWs Nummer dafür im Moment — nur um die Zeile in REW zu finden. Ein Filter oder eine Sortierung nummeriert neu, deshalb wird sie nirgends gespeichert.',
        "capImportPicked": 'Nach Namen abgehakt: {n}.',
        "capImportDupTip": 'REW zeigt unter diesem Namen mehr als eine Messung. Welche davon geworden ist, sagt der Mensch — deshalb ist keine abgehakt.',
        "capImportDupNote": 'Derselbe Name zweimal in REW: {names}. Keine ist abgehakt — wähle die gemeinte.',
        "capImportRewOrder": 'REWs eigene Reihenfolge — eines der Daten war nicht lesbar, also wird die Aufnahmezeit nicht verwendet.',
        "capImportMissing": '{n} der von diesem Projekt übernommenen Messungen fehlen in dieser Liste — gelöscht oder in REW durch einen Filter verborgen.',
        "capImportEmpty": 'Nichts zu zeigen.',
        "capImportAlready": 'Bereits in dieses Projekt übernommen.',
        "capImportDone": 'Übernommen: {n}.',
        "protRefused": '{channel}: {why}',
        "protBtn": 'Schutz',
        "protBtnTip": 'Bei Rohmessungen gib die Schutzfilter an. Ihr Vorhandensein ist für die Mathematik das '
                      'Signal, die Messungen von ihrer Wirkung zu befreien.',
        "protNoChannels": 'Dieses Projekt nennt noch keine Kanäle. Sie kommen aus project.json, das der Intake schreibt — bis dahin gibt es nichts, wozu man einen Schutzfilter eintragen könnte.',
        ...
        "interviewPlaceholder": 'Antwort eingeben…',
        "interviewConnecting": 'Verbinde…',
        "interviewThinking": 'Denkt…',
        "interviewYourTurn": 'Du bist dran.',
        "interviewYou": 'Du',
        "interviewSystem": 'TCC',
        "interviewSaved": '✅ Profil geschrieben: {path}',
        "interviewDone": 'Das Interview ist beendet — dieses Fenster kann geschlossen werden.',
        "interviewEnded": 'Das Interview ist stehengeblieben — es kommt nichts mehr. Schließe dieses Fenster und öffne den normalen Dialog.',
        "interviewError": 'Sitzungsfehler.',
        "preset": 'Preset',
        "target": 'Zielkurve',
        ...
        "legFoundShort": "in REW",
        "legDoneShort": "fertig",
        "legBadShort": "unbrauchbar",
        "legSkipShort": "übersprungen",
        "legWait": 'warte',
        ...
        "measRead": 'Die Daten aus REW lesen, abgeglichen mit den erwarteten Messungen.',
        "measReading": 'Lese aus REW…',
        "measReadCancelled": 'REW zeigt {n} Messung(en). Nichts übernommen.',
        ...
        "assignNames": 'Benenne die Messungen in REW nach den Regeln, in einer Reihenfolge, die du selbst festlegst.',
        "capImportColName": 'neuer Name',
        ...
        "capImportOffGrammar": '„{name}“ passt nicht zur Namensgrammatik: {why}.',
        "capImportHp": 'HP',
        "capImportLp": 'TP',
        "capImportProtClash": 'Zwei Zeilen beschreiben verschiedene Signalwege für denselben Kanal: {channels}. Es wurde nichts eingetragen.',
        "capImportProtSaved": 'Schutz eingetragen für: {channels}.',
        "capImportProtRefusedLine": 'Schutz nicht eingetragen — {line}',
        "capImportProtRefused": '{channel}: {why}',
        "protNotInRecord": 'Der Schutz für {channels} wurde ohne Fehler eingetragen, aber das Protokoll der Runde enthält ihn nicht: TCC hat nicht geschrieben, was es für geschrieben hält. Das ist ein Fehler in TCC — melde ihn bitte (⚙ ▸ Problem melden).',
        "capImportGiveNames": 'Namen vergeben',
        "capImportRenaming": 'Benenne {n} Messung(en) in REW um…',
        "capImportRetake": 'Später aufgenommen als die darunter — eine Wiederholung. Prüfe, welcher Name darauf landet.',
        "capImportNoUuid": 'REW gibt dieser Messung keine uuid, nach dem Umbenennen ist sie nicht wiederzuerkennen.',
        "capImportUneven": 'Namen und Messungen gehen nicht auf: ohne Namen blieben {rows} Messung(en), übrig blieben {names} Name(n). Meist macht das eine Wiederholung — hake sie ab oder beginne eine Zeile tiefer.',
        "capImportClash": 'REW hätte einen Namen doppelt: {names}. Es wurde nichts gesendet.',
        "capImportGone": 'REW zeigt die Messung, die {title} werden sollte, nicht mehr — gelöscht oder durch einen Filter verborgen. Weiter wurde nichts umbenannt.',
        "capImportRenamed": 'Übernommen: {n}, umbenannt: {renamed}.',
        "capImportRenameFail": 'Umbenannt: {n}, dann gestoppt: {error} Übernommen: {taken}.',
        "captureOrderMoveTip": "Die ausgewählten Zeilen gemeinsam verschieben: an den Anfang, eine nach oben, eine nach unten, ans Ende.",
        "captureOrderCopyFrom": "Reihenfolge wie bei {method}",
        "captureOrderSave": "Reihenfolge speichern",
        "captureOrderSaveTip": "Diese Reihenfolge für diese Methode und dieses Preset merken, damit sich die Liste beim nächsten Mal so öffnet.",
        "captureOrderSaved": "Für {method} gespeichert.",
        "captureOrderTitle": 'Messreihenfolge',
        "captureOrderHint": "Wähle die Messmethode und zieh dann die Zeilen so, dass die Reihenfolge der entspricht, in der du die Kanäle in REW tatsächlich misst. Mehrere Zeilen lassen sich auswählen (Shift für einen Bereich, Cmd/Strg für einzelne) und gemeinsam verschieben. „Reihenfolge speichern“ merkt sie für diese Methode und dieses Preset — beim nächsten Mal öffnet sich die Liste so.",
        "captureMethodSw": 'SW',
        "captureMethodRta": 'RTA',
        "captureMethodRtaGroup": 'RTA GROUP',
        ...
        "fbBigTip": 'Ein Fehler, eine Idee, eine Frage, „das ergibt keinen Sinn“ — alles kommt hierher. Ein '
                    'Screenshot kann mit.',
        "fbHead": 'Dem Entwickler schreiben',
        "fbHint": 'Sag uns, was dir gefällt / was zu ändern ist. Nutze die Schaltflächen B / I / Liste — '
                  'Markdown von Hand ist nicht nötig.',
        "fbPh": 'Was ist passiert, was ändern, was ist unklar…',
        "fbCancel": 'Abbrechen',
        "fbShotsAdd": 'Screenshots hinzufügen…',
        "fbShotsKind": 'Bilder',
        "fbShotsPick": 'Screenshots, die mit dem Bericht gehen',
        "fbShotsWarn": 'Das geht in ein ÖFFENTLICHES Repository und lässt sich nicht zurückholen. Sieh dir jedes Bild zuerst an: ein Fensterfoto trägt den Dateipfad, das Auto und alles andere, was auf dem Bildschirm war. Klick öffnet es in voller Größe; × entfernt es.',
        "fbShotsOpen": 'in voller Größe öffnen',
        "fbShotsDrop": 'dieses nicht senden',
        "fbShotsAlt": 'Screenshot {n}',
        "fbShotsUnreadable": 'Geht nicht mit — konnte nicht geöffnet werden, um es zu zeigen: {names}',
        "fbShotsFailed": 'Gestoppt: {problem}. Bereits veröffentlicht und NICHT zurückholbar: {n}.',
        "fbSendGithub": 'An GitHub senden →',
        "fbSendForm": 'Senden →',
        "fbVia": 'Wie senden:',
        "fbViaGithub": 'GitHub-Issue (ich habe ein Konto)',
        "fbViaForm": 'Ohne GitHub — direkt an den Entwickler, nur Text',
        "fbKind": 'Was ist es:',
        "fbKindProblem": 'ein Problem',
        "fbKindWish": 'ein Wunsch',
        "fbKindFeedback": 'Rückmeldung',
        "fbGoesWith": 'Geht mit deinem Text mit:',
        "fbEmpty": 'Schreib zuerst, was passiert ist.',
        "fbSending": 'Wird gesendet…',
        "fbSent": 'Gesendet — danke.',
        "fbNotSent": 'Nicht gesendet: {problem}. Dein Text liegt in der Zwischenablage.',
        "fbNoConfirm": 'das Formular hat den Empfang nicht bestätigt',
        "fbClose": 'Schließen',
        "fbFrom": 'Von:',
        "fbFromPh": 'Name und Kontakt: E-Mail, Telegram oder Telefon',
        "fbNoSender": 'Schreib, wer du bist und wie man dir antwortet — der Entwickler antwortet Menschen.',
        "fbImpact": 'Wie sehr hält es dein Tuning auf?',
        "fbImpactStops": 'Es hält mich auf: Ich kann nicht weiter abstimmen',
        "fbImpactWorkaround": 'Es stört, aber ich komme darum herum',
        "fbImpactNone": 'Es stört nicht',
        "fbNoImpact": 'Wähle, wie sehr es dein Tuning aufhält.',
        "dialog": 'KI-Dialog',
        "dialogSub": 'Generator ↔ Critic ↔ Arbiter',
        "planTitle": 'Plan — Ist',
        ...
        "gateAskNever": 'Nicht fragen',
        "gateAskForeign": 'Außerhalb des Projekts',
        "gateAskWrites": 'Jeder Schreibvorgang',
        "gateAskTitle": 'Agentenbefehle',
        "gateAskBody": 'Die Tuning-Sitzung führt Befehle auf diesem Rechner aus — sie liest Messungen und schreibt Projektdateien. Wie viel davon soll anhalten und fragen? Einmal gefragt; jederzeit im Menü änderbar. Was sich nicht rückgängig machen lässt, fragt in jedem Fall.',
        ...
        "queueSendNow": 'Unterbrechen und senden',
        "queueSendNowTip": 'Beendet den laufenden Zug und sendet deine Nachricht jetzt. Ohne das geht sie von selbst raus, wenn dieser Zug endet.',
        ...
        "curveZoomDetailShort": 'D',
        "curveZoomOut": 'Horizontal verkleinern — größerer Bereich',
        "curveZoomOutShort": 'X−',
        "curveZoomIn": 'Horizontal vergrößern — kleinerer Bereich',
        "curveZoomInShort": 'X+',
        "curveZoomYOut": 'Vertikal stauchen — flachere Kurven, größerer Bereich',
        "curveZoomYOutShort": 'Y−',
        "curveZoomYIn": 'Vertikal strecken — höhere Kurven, kleinerer Bereich',
        "curveZoomYInShort": 'Y+',
        ...
        "curveBtn": 'Kurvenanalyse. Delays und APF-Filter. Ihre Wirkung auf die Phase, den Impuls und die Summe '
                    'der Kurven.',
        ...
        "sessionDropped": 'Die Verbindung zum Modell ist abgerissen — diese Antwort kommt von der Hülle, nicht vom Modell. Diese Sitzung trägt keine weitere Nachricht; beginne eine neue über «{new}» oben.',
        ...
        "lsnBtn": 'Hören',
        "lsnBtnTip": 'Eine Vorlage für die Rückmeldung zu den Testtiteln — die Vorschläge kommen aus dem, was die '
                     'Bibliothek ohnehin analysiert.',
